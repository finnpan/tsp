...
extern char *ParameterFileName, *ProblemFileName;
extern char *Name, *Type, *EdgeWeightType, *EdgeWeightFormat, *EdgeDataFormat,
    *NodeCoordType, *DisplayDataType;
extern int CandidateSetSymmetric, CoordType, ExtraCandidateSetSymmetric,
    PatchingAExtended, PatchingARestricted, PatchingCExtended,
    PatchingCRestricted, ProblemType, WeightType, WeightFormat;

extern FILE *ParameterFile, *ProblemFile;
