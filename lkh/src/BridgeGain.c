        ...
        for (Nt2 = t2->CandidateSet; (t3 = Nt2->To); Nt2++) {
            ...
            for (X4 = 1; X4 <= 2; X4++) {
                ...
                for (Nt4 = t4->CandidateSet; (t5 = Nt4->To); Nt4++) {
                    ...
                    G3 = G2 - Nt4->Cost;
                    G4 = G3 + C(t5, t6);
                    if (!Forbidden(t6, t1) && (!c || G4 - c(t6, t1) > 0)
                        && (Gain = G4 - C(t6, t1)) > 0) {
                        if (X4 == 1)
                            Swap4(s1, s2, s4, t3, t4, t1, s1, s3, s2, t5, t6,
                                  t1);
                        else
                    ...
                    for (Nt6 = t6->CandidateSet; (t7 = Nt6->To); Nt6++) {
                        ...
                        if (t8 == t1 || (t7 == t1 && t8 == t2)
                            || (t7 == t3 && t8 == t4) || (t7 == t4 && t8 == t3)
                            || (t7 == s1 && t8 == s2) || (t7 == s2 && t8 == s1)
                            || (t7 == s3 && t8 == s4) || (t7 == s4 && t8 == s3))
                            continue;
                        if (Fixed(t7, t8) || Forbidden(t8, t1)) continue;
                        G5 = G4 - Nt6->Cost;
                        G6 = G5 + C(t7, t8);
