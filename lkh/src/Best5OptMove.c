...
Node* Best5OptMove(Node* t1, Node* t2, GainType* G0, GainType* Gain)
{
    ...
    int Case6 = 0, Case8 = 0, Case10 = 0, BestCase10 = 0, X4, X6, X8, X10,
        BTW275 = 0, BTW674 = 0, BTW571 = 0, BTW376 = 0, BTW574 = 0, BTW671 = 0,
                            ...
                            for (Nt8 = t8->CandidateSet; (t9 = Nt8->To);
                                ...
                                for (X10 = 1; X10 <= 2; X10++) {
                                    if (X10 == 1) {
                                        ...
                                        Case10 += 31;
                                        t10 = t10 == t9->Pred ? t9->Suc
                                                              : t9->Pred;
                                    }
                                    if (t10 == t1 || (t9 == t3 && t10 == t4)
                                        || (t9 == t4 && t10 == t3)
                                        || (t9 == t5 && t10 == t6)
                                        || (t9 == t6 && t10 == t5))
                                        continue;
                                    if (Fixed(t9, t10)) continue;
                                    G8 = G7 + C(t9, t10);
                                    if (!Forbidden(t10, t1)
                                        && (!c || G8 - c(t10, t1) > 0)
                                        && (*Gain = G8 - C(t10, t1)) > 0) {
