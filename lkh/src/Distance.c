...
int Distance_1(__attribute__((unused)) Node* Na,
               __attribute__((unused)) Node* Nb)
{
    return 1;
}

int Distance_LARGE(__attribute__((unused)) Node* Na,
                   __attribute__((unused)) Node* Nb)
{
    return 10000000;
}
...
{
    return (int)(fabs(Na->X - Nb->X) + fabs(Na->Y - Nb->Y) + fabs(Na->Z - Nb->Z)
                 + 0.5);
}
