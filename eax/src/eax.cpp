        ...
        while (flagCircle==0) {
            ...
            switch(prType) {
                ...
                case 2:
                    ...
                    if (r==0) {
                        std::swap(_nearData[pr][posiCurr%2+1], _nearData[pr][posiCurr%2+3]);
                    }
                    break;
                case 3:
            ...
            if (_nearData[ci][0]==2) {
                if (ci==st) {
                    if (checkKoritsu[st]==0) {
                        if ((posiCurr-checkKoritsu[st])%2==0) {
                            if (_nearData[st][posiCurr%2+1]==pr) {
                                std::swap(_nearData[ci][posiCurr%2+1], _nearData[ci][posiCurr%2+3]);
                            }
                    ...
                    if ((posiCurr-checkKoritsu[ci])%2==0) {
                        ...
                        std::swap(_nearData[ci][(posiCurr+1)%2+1], _nearData[ci][(posiCurr+1)%2+3]);
                        prType=3;
                    }
                }
